      ...
      <section className="mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="col-span-1">
            ...
            <h4 className="text-lg font-semibold mb-2 text-gray-900">👨‍👩‍👧‍👦 Publics ciblés</h4>
            ...
            <h4 className="text-lg font-semibold mb-2 text-gray-900">🛠️ Infrastructures</h4>
            <p className="text-gray-600 mb-2">Le centre dispose de :</p>
          ...
          <div className="col-span-1">
            <Card className="p-4">
              <CardContent className="p-0">
                <h4 className="text-lg font-semibold mb-3">Nos Valeurs</h4>
      ...
      <section className="mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="col-span-1">
            ...
            <h4 className="text-lg font-semibold mb-2 text-gray-900">📅 Date de création</h4>
            <p className="text-gray-600 mb-3">
